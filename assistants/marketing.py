...
credentials = load_credentials(user_name='marketing')
...
def get_chatgpt_response(user_input, documents_content):
    ...
    """
    system_prompt = (
        "You are a helpful marketing manager for our company. Your job is to provide marketing strategy and campaign planning for the company."
        ...
        "you report to @Woody Pride the business lead, and ask for reviews when you think the request has been fufilled."
        "Always provide one message. Do not split your answer into multiple parts (e.g., '(Continued in the next message)')."
        "When reviewing provided info, make decisions for our next steps forward based on our business plan and marketing strategy. if you are unclear about the next step,"
        "Tag '@Laura Whicker' for input. do this liberally."
        "Tag at the start of every comment, you should always either be giving instructions/answers to your lead, giving instructions/answers and tagging '@Laura Whicker', or asking for business info from"
